...
public class Main {
    public static void main(String[] args) throws IOException {
        Cépage chenin = Cépage.withDescription("chenin", "Cépage phare de la Vallée de la Loire, le chenin, aussi appelé pinot de la Loire (pineau). iL serait originaire de l’Anjou où il aurait été cultivé par les moines de l’Abbaye de Saint-Maur située entre Angers et Saumur dès le 6ème siècle.");
        Cépage cabernetFranc = Cépage.withDescription("cabernet franc", "Le cabernet franc est l’un des plus anciens cépages rouge du bordelais. Le Libournais est son terroir de prédilection.");
        Cépage cabernetSauvignon = Cépage.withDescription("cabernet sauvignon", "Le cabernet-sauvignon est un des cépages phares de Bordeaux. C’est un grand cépage rouge tant par sa superficie d’encépagement (2ème cépage le plus planté) que par sa qualité.");

        Région valléeLoire = Région.create(valléeDeLoire -> valléeDeLoire
