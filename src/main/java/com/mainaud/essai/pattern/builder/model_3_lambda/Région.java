...
public class Région implements RégionLec {
    ...
    public static Région of(Consumer<Builder> factory) {
    ...
    public static final class Builder {
        ...
        public Builder addSousRégion(Consumer<Builder> sousRégion) {
            région.sousRégions.add(Région.of(sousRégion.andThen(b -> b.setRégion(région))));
            return this;
        }

        public Builder addAppellation(Consumer<Appellation.Builder> appellation) {
            région.appellations.add(Appellation.of(appellation.andThen(a -> a.setRégion(région))));
            return this;
        }
